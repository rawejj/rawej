...
describe('Metadata Functions', () => {
  ...
  describe('getTranslations', () => {
    it('loads English translations successfully', async () => {
      ...
      expect(translations.meta.description).toBe('Book appointments with professional doctors');
    });
  ...
  describe('generateMetadata', () => {
    it('generates metadata for English', async () => {
      ...
      expect(metadata.description).toBe('Book appointments with professional doctors');
    ...
    it('generates metadata for German', async () => {
      ...
      expect(metadata.description).toBe('Vereinbaren Sie Termine mit professionellen Ärzten');
    });
    ...
    it('includes OpenGraph metadata', async () => {
      ...
      expect(metadata.openGraph?.description).toBe('Book appointments with professional doctors');
    ...
    it('includes Twitter metadata', async () => {
      ...
      expect(metadata.twitter?.title).toBe('Doctor Appointment Booking');
      expect(metadata.twitter?.description).toBe('Book appointments with professional doctors');
    });
