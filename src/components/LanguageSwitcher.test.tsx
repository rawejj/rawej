...
function renderWithProviders(
  ui: React.ReactNode,
  initialLanguage: LanguageKey = "en",
  theme: Theme = "light",
) {
  return render(
...
describe("LanguageSwitcher", () => {
  ...
  describe("dropdown opening and closing", () => {
    ...
    it("closes dropdown when language is selected", async () => {
      ...
      const deutschButton = screen.getByRole("button", {
  ...
  describe("language selection", () => {
    ...
    it("switches to Persian language", () => {
      ...
      const button = screen.getByRole("button", { name: /language selector/i });
      fireEvent.click(button);
      const persianButton = screen.getByRole("button", {
        name: /switch to persian/i,
      });
  ...
  describe("mouse interactions", () => {
    it("shows hover effect on language options", () => {
      ...
      const button = screen.getByRole("button", { name: /language selector/i });
      fireEvent.click(button);
      const languageOption = screen.getByRole("button", {
        name: /switch to deutsch/i,
      });
