...
describe('DropdownMenu', () => {
  ...
  it('calls onClose when backdrop is clicked', () => {
    ...
    const backdrop = container.querySelector('[data-testid="dropdown-backdrop"]');
    if (backdrop) {
  ...
  it('uses custom backdrop test id when provided', () => {
    const { container } = render(
      <DropdownMenu
        {...defaultProps}
        backdropTestId="custom-backdrop"
      />
    );
    expect(container.querySelector('[data-testid="custom-backdrop"]')).toBeInTheDocument();
  });
